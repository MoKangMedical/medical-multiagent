...
1. **构建镜像**
```bash
docker build -t medical-multiagent .
```

2. **运行容器**
```bash
docker run -d -p 8000:8000 --name medical-multiagent medical-multiagent
```
...
- **问题反馈**: https://github.com/MoKangMedical/medical-multiagent/issues
